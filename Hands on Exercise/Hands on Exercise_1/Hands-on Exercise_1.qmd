...
The code chunk below uses p_load() of pacman package to check if tidyverse pakages are installed in the computer. If they are, them they will be launched into R.
