...
In this section, you will learn how to plot a calender heatmap programmatically by using ggplot2 package.![](images/clipboard-4109122311.png)
...
-   a tibble data table called `grouped` is derived...
-   a new field called `n` is derived by using `group_by()` and `count()` functions.
-   `na.omit()` is used to exclude missing value.
-   `geom_tile()` is used to plot tiles (grids) at each x and y position. `color` and `size` arguments are used...
-   `theme_tufte()` of **ggthemes** package is used...
